...
My journey through the **[LeetCode 75](https://leetcode.com/studyplan/leetcode-75/)** study plan. This repository contains optimized solutions for the 75 essential coding interview questions, organized by pattern.
...
| [Max Number of Vowels in Substring](https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) | 🟡 | 
| [Max Consecutive Ones III](https://leetcode.com/problems/max-consecutive-ones-iii/) | 🟡 | 
| [Longest Subarray of 1's After Deleting One](https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/) | 🟡 | 
...
| [Reorder Routes to Make All Paths Lead to Zero](https://leetcode.com/problems/reorder-routes-to-make-all-paths-lead-to-the-city-zero/) | 🟡 | 
...
| [Best Time to Buy and Sell Stock with Fee](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/) | 🟡 | 
...
| [Minimum Flips to Make a OR b Equal to c](https://leetcode.com/problems/minimum-flips-to-make-a-or-b
...
## 🤝 Contributing
Feel free to open a pull request if you have a more optimized solution!
